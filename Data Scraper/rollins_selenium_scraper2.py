...
Usage:
    ...
    python rollins_selenium_scraper.py --start 2026-03-07 --end 2026-04-30
"""
...
def navigate_to_date(driver, date):
    ...
    try:
        ...
        for attempt in range(20):
            ...
            if count > 0:
                log.info(f"  Schedule loaded: {count} event blocks found")
                time.sleep(1)  # Extra second for full render
                return True
...
def close_modal(driver):
    ...
    try:
        driver.execute_script("""
            ...
            // Fallback: click the Close button by text
